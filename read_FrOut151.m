function FrOut = read_FrOut151(fn)
% Extracts data from FREZCHEM v15.1 output file.
%
% Syntax:
...
%           L* = number of solid species precipitating at/beyond the
...
%
%-----------Salts Precipitating at/beyond the Eutectic (1 x L*)------------
...
%
%           FrOut.eutectic.Teut             Eutectic Temperature*
%           FrOut.eutectic.solid_species    Solid Species (Hydrates)
%                                           Precipitating at/beyond the
%                                           Eutectic
%           FrOut.eutectic.sm               Mass of Solid Salt
%                                           (Hydrates) Precipitating
%                                           at/beyond the Eutectic
%           FrOut.eutectic.rho_ss           Total Density of Solid Salt
%                                           (Hydrates) Precipitating
%                                           at/beyond the Eutectic
%
...
% Species Number
species.num = [1:11,16:25,31:138,201:234]';
% solution/atmospheric species:   1 -  11, 16 - 25
% solid species:                 31 - 138
% solution/atmospheric species: 201 - 234
...
species.str = {'NA';...
    ...
    'FECL3.2KCL.H20';...
    'FE2(SO4)3';...
    'FE2(SO4)3.2K2SO4.14H';... % FE2(SO4)3.2K2SO4.14H2O
    'K2SO4.FESO4.6H2O';...
    'NA2SO4.FESO4.4H2O';...
    'FE2(SO4)3.9H2O';...
    ...
    'FESO4.4H2O';...
    'FE2(SO4)3.7H2O';...
    'FE(II)FE(III)4(SO4)6';... % FE(II)FE(III)4(SO4)6(OH)2.20H2O
    'FE(III)5(SO4)6O(OH).';... % FE(III)5(SO4)6O(OH).20H2O
    'FE(II)FE(III)2(SO4)4';... % FE(II)FE(III)2(SO4)4.22H2O
    'FE(II)FE(III)2(SO4)4';... % FE(II)FE(III)2(SO4)4.14H2O
    'K2FE(II)5FE(III)4(SO';... % K2FE(II)5FE(III)4(SO4)12.18H2O
    'ALCL3.6H2O';...
    'AL2(SO4)3.17H2O';...
    'NABR';...
    'MGBR2';...
    ...
    'KAL(SO4)2.12H2O';...
    'NAAL(SO4)2.12H2O';...
    'FESO4.AL2(SO4)3.22H2';... % FESO4.AL2(SO4)3.22H2
    'AL2SI2O5(OH)4';...
    'MGSO4.AL2(SO4).22H2O';...
    'NACLO4.H2O';...
    'MG(CLO4)2.8H2O';...
...
species.mass = ...
    ...
    mass(strcmp('N',symb))+...
    4*mass(strcmp('H',symb));...    % ( 11) NH4
    mass(strcmp('Cl',symb));...     % ( 16) Cl
    mass(strcmp('S',symb))+...
    4*mass(strcmp('O',symb));...    % ( 17) SO4
    mass(strcmp('O',symb))+...
    mass(strcmp('H',symb));...      % ( 18) OH
    mass(strcmp('H',symb))+...
    mass(strcmp('C',symb))+...
    3*mass(strcmp('O',symb));...    % ( 19) HCO3
    mass(strcmp('C',symb))+...
    3*mass(strcmp('O',symb));...    % ( 20) CO3
    mass(strcmp('H',symb))+...
    mass(strcmp('S',symb))+...
    4*mass(strcmp('O',symb));...    % ( 21) HSO4
    mass(strcmp('N',symb))+...
    3*mass(strcmp('O',symb));...    % ( 22) NO3
    mass(strcmp('Br',symb));...     % ( 23) Br
    mass(strcmp('Cl',symb))+...
    4*mass(strcmp('O',symb));...    % ( 24) ClO4
    mass(strcmp('B',symb))+...
    4*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % ( 25) B(OH)4
    ...
    mass(strcmp('N',symb))+...
    4*mass(strcmp('H',symb))+mass(strcmp('Cl',symb));... % (132) NH4Cl
    2*(mass(strcmp('N',symb))+...
    4*mass(strcmp('H',symb)))+...
    mass(strcmp('S',symb))+4*mass(strcmp('O',symb));... % (133) (NH4)2SO4
    mass(strcmp('N',symb))+...
    3*mass(strcmp('H',symb))+...
    2*mass(strcmp('H',symb))+mass(strcmp('O',symb));... % (134) NH3-H2O
    mass(strcmp('N',symb))+...
    4*mass(strcmp('H',symb))+...
    mass(strcmp('N',symb))+3*mass(strcmp('O',symb));... % (135) NH4NO3
    mass(strcmp('N',symb))+...
    4*mass(strcmp('H',symb))+mass(strcmp('H',symb))+...
    mass(strcmp('C',symb))+3*mass(strcmp('O',symb));... % (136) NH4HCO3
    mass(strcmp('N',symb))+...
    4*mass(strcmp('H',symb))+...
    mass(strcmp('Cl',symb))+4*mass(strcmp('O',symb));... % (137) NH4ClO4
    mass(strcmp('N',symb))+...
    3*mass(strcmp('H',symb))+...
    2*(2*mass(strcmp('H',symb))+mass(strcmp('O',symb)));... % (138) NH3-2H2O
    
    mass(strcmp('C',symb))+...
    2*mass(strcmp('O',symb));...    % (201) CO2
    mass(strcmp('Fe',symb))+...
    mass(strcmp('C',symb))+...
    3*mass(strcmp('O',symb));...    % (202) FeCO3
    mass(strcmp('H',symb))+...
    mass(strcmp('Cl',symb));...     % (203) HCl
    mass(strcmp('Ca',symb))+...
    mass(strcmp('C',symb))+...
    3*mass(strcmp('O',symb));...    % (204) CaCO3
    mass(strcmp('Mg',symb))+...
    mass(strcmp('C',symb))+...
    3*mass(strcmp('O',symb));...    % (205) MgCO3
    mass(strcmp('H',symb))+...
    mass(strcmp('N',symb))+...
    3*mass(strcmp('O',symb));...    % (206) HNO3 (g)
    2*mass(strcmp('H',symb))+...
    mass(strcmp('S',symb))+...
    4*mass(strcmp('O',symb));...    % (207) H2SO4 (g)
    2*mass(strcmp('H',symb))+...
    mass(strcmp('O',symb));...      % (208) H2O (g)
    mass(strcmp('C',symb))+...
    2*mass(strcmp('O',symb));...    % (209) CO2 (g)
    2*mass(strcmp('H',symb))+...
    mass(strcmp('O',symb));...      % (210) H2O
    
    2*mass(strcmp('O',symb));...    % (211) O2 (g)
    2*mass(strcmp('O',symb));...    % (212) O2
    2*mass(strcmp('H',symb));...    % (213) H2
    mass(strcmp('C',symb))+...
    4*mass(strcmp('H',symb));...    % (214) CH4 (g)
    mass(strcmp('C',symb))+...
    4*mass(strcmp('H',symb));...    % (215) CH4
    mass(strcmp('Fe',symb))+...
    2*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (216) Fe(OH)2
    mass(strcmp('Fe',symb))+...
    3*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (217) Fe(OH)3 -
    mass(strcmp('Fe',symb))+...
    (mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (218) Fe(OH)
    mass(strcmp('Fe',symb))+...
    2*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (219) Fe(OH)2 +
    mass(strcmp('Fe',symb))+...
    3*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (220) Fe(OH)3
    mass(strcmp('Fe',symb))+...
    4*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (221) Fe(OH)4
    mass(strcmp('Al',symb))+...
    (mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (222) Al(OH)
    mass(strcmp('Al',symb))+...
    2*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (223) Al(OH)2
    mass(strcmp('Al',symb))+...
    3*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (224) Al(OH)3
    mass(strcmp('Al',symb))+...
    4*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (225) Al(OH)4
    mass(strcmp('Si',symb))+...
    4*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (226) Si(OH)4
    mass(strcmp('Si',symb))+...
    mass((strcmp('O',symb)))+...
    3*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (227) SiO(OH)3
    mass(strcmp('Sr',symb))+...
    mass(strcmp('C',symb))+...
    3*mass(strcmp('O',symb));...    % (228) SrCO3
    mass(strcmp('B',symb))+...
    3*(mass(strcmp('O',symb))+...
    mass(strcmp('H',symb)));...     % (229) B(OH)3
    mass(strcmp('F',symb));...      % (230) F
    mass(strcmp('H',symb))+...
    mass(strcmp('F',symb));...      % (231) HF
    mass(strcmp('Sr',symb));...     % (232) Sr
    mass(strcmp('N',symb))+...
    3*mass(strcmp('H',symb));...    % (233) NH3 (g)
    mass(strcmp('N',symb))+...
    3*mass(strcmp('H',symb))];      % (234) NH3

% Species Molar Volume (cm^3/mol)
species.molvol = ... % @ 298 K
    [nan(length(1:11),1);... % (  1) - ( 11)
    nan(length(16:25),1);... % ( 16) - ( 25)
    ...
    74.69;...   % ( 48) CaSO4-2H2O
    45.94;...   % ( 49) CaSO4
    220.50;...  % ( 50) MgSO4-11H2O (12H2Onan)
    ...
    nan;...     % ( 89) FeCl3-10H2O
    nan;...     % ( 90) FeCl3-6H2O
    nan;...     % ( 91) FeCl3-2KCl-H2O
    nan;...     % ( 92) Fe2(SO4)3
    nan;...     % ( 93) Fe2(SO4)3-2(K2SO4)14H2O
    nan;...     % ( 94) K2SO4FeSO46H2O
    nan;...     % ( 95) Na2SO4FeSO4-4H2O
    nan;...     % ( 96) Fe2(SO4)3-9H2O
    nan;...     % ( 97) Fe2(SO4)3-H2SO4-8H2O
    nan;...     % ( 98) KFe3-(SO4)2-6(OH)
    nan;...     % ( 99) NaFe3(SO4)2-6(OH)
    nan;...     % (100) H3OFe3(SO4)2-6(OH)
    nan;...     % (101) Fe2O3
    nan;...     % (102) FeO(OH)
    nan;...     % (103) FeO(OH)
    nan;...     % (104) FeO-OH(3/4)SO4(1/8)
    nan;...     % (105) FeSO4-4(H2O)
    nan;...     % (106) Fe2(SO4)3-7H2O
    nan;...     % (107) Fe(Fe)4(SO4)6(OH)2-20H2O
    nan;...     % (108) Fe5(SO4)6O(OH)-20H2O
    nan;...     % (109) FeFe2(SO4)4-22H2O
    nan;...     % (110) FeFe2(SO4)4-14H2O
    nan;...     % (111) K2Fe5Fe4(SO4)12-(H2O)18
    nan;...     % (112) AlCl3-6H2O
    nan;...     % (113) Al2(SO4)3-17H2O
    nan;...     % (114) NaBr
    nan;...     % (115) MgBr2
    nan;...     % (116) Al(OH)3
    nan;...     % (117) SiO2
    nan;...     % (118) SiO2
    nan;...     % (119) KAl3(SO4)2(OH)6
    nan;...     % (120) NaAl3(SO4)2(OH)6
    nan;...     % (121) KAl2(SO4)2-12H2O
    nan;...     % (122) NaAl(SO4)2-12H2O
    nan;...     % (123) FeSO4Al2(SO4)3-22(H2O)
    nan;...     % (124) Al2Si2O5(OH)4
    nan;...     % (125) MgSO4Al2(SO4)3-22(H2O)
    ...
    nan(length(201:234),1)]; % (201) - (234)

% Species Density (g/cm^3)
species.rho = species.mass./species.molvol;

%% Read-In File
k_solid_tot = length(31:138); % solid species count (independent of input file)
solid_species_mass = species.mass(ismember(species.num,31:138));
rho_solid_species = species.rho(ismember(species.num,31:138));
...
while ischar(tline)
    ...
    if ~isempty(tline) & tline~=-1
        ...
        elseif contains(tline,'SOLIDS') | contains(tline,'AT T =')
         ...
         elseif contains(tline,'NEW CONVERGENCE CRITERION')
             if ~isempty(solids)
                 clear solids Teut
            end
        end
...
FrOut.rho_ss = FrOut.T; % Mean Density of Solid Salt (Hydrates)
